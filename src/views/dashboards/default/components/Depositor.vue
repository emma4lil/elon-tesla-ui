<template>
  <v-btn :block="blocked" color="primary" size="large" variant="outlined" class="my-2 pa-2" @click="depositDialog = true"> Deposit </v-btn>
      ...
      <v-card-text class="pt-4">
        ...
        <v-text-field v-model="selectedCurrency.address" label="Wallet address" readonly variant="outlined" class="mb-2">
          <template v-slot:append>
            <v-btn size="small" @click="copyAddress"> copy </v-btn>
          </template>
        </v-text-field>

        <div class="text-h3 text-center pb-2">Deposit ${{ props.amount }} <v-btn size="small" variant="outlined">I have paid</v-btn></div>
